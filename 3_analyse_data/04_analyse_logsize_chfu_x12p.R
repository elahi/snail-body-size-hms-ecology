################################################################################
##' @title Analyze log size, Tegula (Chlorostoma) funebralis
##' @author Robin Elahi
...
##### PACKAGES, DATA #####
#source("3_analyse_data/02_explore_data_chfu.R")
...
#       formula = size_log ~ era * sampleArea,  
...
run_brm_truncated(dat = waraDF, p_vector = seq(0, 0.5, by = 0.05), 
