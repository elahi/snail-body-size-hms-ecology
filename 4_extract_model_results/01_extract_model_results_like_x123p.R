################################################################################
##' @title Extract model summaries, Littorina keenae (x123; full model, pooled)
##' @author Robin Elahi
...
model_path <- "brm_models/like/logsize_x123p/"
...
ic_df %>% 
  ...
  labs(x = "Minimum quantile", y = "WAIC", title = "Littorina keenae") 
