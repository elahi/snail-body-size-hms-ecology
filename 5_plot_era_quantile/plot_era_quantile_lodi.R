################################################################################
##' @title Plot era effect by quantile, Lottia digitalis
##' @author Robin Elahi
...
coefs_df %>%
  ...
  labs(x = "Lower size threshold (quantile)", y = "Proportional change in size", title = "Lottia digitalis") + 
...
#ggsave("figs/plot_model_coefs_lodi.png", height = 3.5, width = 5)
